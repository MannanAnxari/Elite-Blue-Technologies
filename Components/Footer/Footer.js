          ...
          <div className="row">
            ...
            <div className="column col-xl-4 col-lg-5 col-md-5 col-sm-12">
              <div className="footer-widget logo-widget">
                <div className="widget-content">
                  <div className="logo">
                    <Link href="/"><Image id="fLogo" src={Logo} alt="EliteBlue Technologies" className='h-100' /></Link>
                  </div>
                  <div className="text">
                  ...
                  <div className="mt-3">
                    <Button text="Get in Touch" type="light" link="/contact" />
                  </div>
            ...
            <div className="column col-xl-2 col-lg-6 col-md-6 col-sm-12">
              <div className="footer-widget links-widget">
                <div className="widget-content">
                  <h6 className="mb-4 mt-md-0 mt-4">Site Map</h6>
                  <div className="row">
                    <div className="col-md-12 col-sm-12">
                      <ul>
                        <li><Link href="/about">About</Link></li>
                        {/*<li><Link href="#">Servies</Link></li>*/}
            ...
            <div className="column col-xl-3 col-lg-6 col-md-6 col-sm-12">
              <div className="footer-widget newsletter-widget">
                <div className="widget-content">
                  ...
                  <div className="py-md-2 py-4 mt-md-4">
                    <h6 className="m-0">Follow US</h6>
