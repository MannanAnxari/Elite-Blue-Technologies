...
import email from "@/public/Assets/email0.png";
import phone from "@/public/Assets/phone0.png";
// import shape from "@/public/Assets/img/shape.png";
import address from "@/public/Assets/location0.png";
                        ...
                        <div className="col-lg-4">
                            <div className="contact__content">
                                <div className="head">
                                    ...
                                    <ul className="contact-info my-5">
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} autocomplete="off" >
            <div className="row">
                ...
                <div className="form-group col-lg-12 col-md-12 col-sm-12">
                    <button type="submit" className="theme-btn btn-style-two border-0" >
