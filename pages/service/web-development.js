...
import serviceone from "@/public/Assets/development.png";
import sr1 from '@/public/Assets/services/e-commerce-development.png'
import sr2 from '@/public/Assets/services/web-portal.png'
import sr3 from '@/public/Assets/services/web-&-app-development.png'
...
export default function WebDevelopment() {
    ...
    return (
        <>
            <Layout title="Web Development - Elite Blue Technologies" metaTitle="Elite Blue Technologies" metaDescription="At Elite Blue Technologies, our focus is on delivering results for our clients. As an expert digital agency, we specialize in building brands and attracting customers, not just making empty promises. Let us help you grow your business through creative and effective digital solutions.">
                                ...
                                <div className="services-card px-2 services-card-h px-lg-4">
                                    ...
                                    <div className="row p-3 ">
                                        ...
                                        <div className="col-12 my-3 mb-5">
                                            <Image src={sr1} alt="Services" className='ServicesImg h-auto' draggable="false" />
                                        </div>
                                        <div className="col-12 my-auto">
                                            <div>
                                                ...
                                                <div className="link-box"><a href='#'>
                                                    <span className=""> <Image src={AngleRight} alt="Angle" className='angle w-auto h-100' /></span>
                                                </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className='col-sm-12 col-md-6 col-lg-4 my-4 '>
                                <div className="services-card px-2 services-card-h px-lg-4">
                                    ...
                                    <div className="row p-3 ">
                                        ...
                                        <div className="col-12 my-3 mb-5">
                                            <Image src={sr2} alt="Services" className='ServicesImg h-auto' draggable="false" />
                                        </div>
                                        <div className="col-12 my-auto">
                                            <div>
                            ...
                            <div className='col-sm-12 col-md-6 col-lg-4 my-4 '>
                                <div className="services-card px-2 services-card-h px-lg-4">
                                    ...
                                    <div className="row p-3 ">
                                        ...
                                        <div className="col-12 my-3 mb-5">
                                            <Image src={sr3} alt="Services" className='ServicesImg h-auto' draggable="false" />
                                        </div>
                                        <div className="col-12 my-auto">
                                            <div>
