...
import serviceone from "@/public/Assets/mobile-app-dev.png";
import Tech from '@/Components/Technologies/tech';
import c2 from '@/public/Assets/services/CkP-4uSWgAAa4Cm.png';
...
export default function AppDevelpment() {
    return (
        <>
            <Layout title="App Development - Elite Blue Technologies" metaTitle="Elite Blue Technologies" metaDescription="At Elite Blue Technologies, our focus is on delivering results for our clients. As an expert digital agency, we specialize in building brands and attracting customers, not just making empty promises. Let us help you grow your business through creative and effective digital solutions.">
                ...
                <section className="section py-0">
                    <div className="container">
                        ...
                        <div className="row ">
                            <div className="col-lg-6 col-12 my-auto">
                                <Image src={c2} alt="About" draggable="false" className='aboutimg w-100 h-auto d-md-block d-none' />
                ...
                {/*        <div className="row ">*/}
                {/*            <div className="col-lg-6 col-12 my-auto">*/}
                {/*               <Image src={c1} alt="About" draggable="false" className='aboutimg w-100' />*/}
                {/*            </div>*/}
                {/*            <div className="col-lg-6 col-12 my-auto">*/}
                {/*                <div className="inner">*/}
                {/*                    <div className="head py-2 mb-auto">*/}
                ...
                {/*            </div>*/}
                {/*            <div className="col-lg-6 col-12 my-auto">*/}
                {/*               <Image src={c2} alt="About" draggable="false" className='aboutimg w-100' />*/}
                {/*            </div>*/}
                {/*        </div>*/}
                {/*    </div>*/}
                {/*</section>*/}
