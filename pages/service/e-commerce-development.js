...
import serviceone from "@/public/Assets/e-commerce.png";
...
export default function ECommerceDevelopment() {
  return (
    <>
      <Layout title="E-Commerce Development - Elite Blue Technologies" metaTitle="Elite Blue Technologies" metaDescription="At Elite Blue Technologies, our focus is on delivering results for our clients. As an expert digital agency, we specialize in building brands and attracting customers, not just making empty promises. Let us help you grow your business through creative and effective digital solutions.">
          ...
          <div className="container">
            ...
            <div className="row ">
              ...
              <div className="col-lg-6 col-12 banner-img-h">
                <Image src={serviceone} alt="About" draggable="false" className='aboutimg h-auto' style={{ width: '100%' }} />
              </div>
            </div>
          </div>
        </section>
