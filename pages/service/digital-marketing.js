...
import serviceone from "@/public/Assets/SMM.png";
import ourwork from "@/public/Assets/services/cro-img.png";
                ...
                <section className="section bg-radial">
                    <div className="container">
                        <div className="row ">
                            ...
                            <div className="col-lg-6 col-12 my-auto">
                                <Image src={ourwork} alt="About" draggable="false" className='rounded-3 shadow-lg w-100' />
                            </div>
                        </div>
