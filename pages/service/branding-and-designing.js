...
import serviceone from "@/public/Assets/graphics.png";
import g1 from '@/public/Assets/services/Brand-Identity.jpg';
import g2 from '@/public/Assets/services/Graphic-Design-2.jpg';
import g3 from '@/public/Assets/services/Business-Card-design.jpg';
import g4 from '@/public/Assets/services/Infographics-Design.jpg';
import g5 from '@/public/Assets/services/Packaging-img.jpg';
...
export default function BrandingNDesign() {
    return (
        <>
            <Layout title="Digital Marketing - Elite Blue Technologies" metaTitle="Elite Blue Technologies" metaDescription="At Elite Blue Technologies, our focus is on delivering results for our clients. As an expert digital agency, we specialize in building brands and attracting customers, not just making empty promises. Let us help you grow your business through creative and effective digital solutions.">
                    ...
                    <div className="container p-5">
                        <div className="row ">
                            ...
                            <div className="col-lg-6 col-12">
                               <Image src=".." alt="About" draggable="false" className='aboutimg w-100' />
                            </div>
                        </div>
                    </div>
                </div>
  ...
  ==========================================================
                ...
                <div className="container ">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-12 banner-img-h text-center">
                           <Image src='Assets/bg1 icon.png'  alt="About" draggable="false" style={{width:"50%"}} />
                        </div>
                    </div>
                </div>
            </section> */}
                    ...
                    <div className="container">
                        ...
                        <div className="row ">
                            ...
                            <div className="col-lg-6 col-12 banner-img-h">
                                <Image src={serviceone} alt="About" draggable="false" className='aboutimg h-auto' style={{ width: '70%' }} />
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row ">
                            <div className="col-lg-6 col-12 my-auto">
                                <h2 className="heading heading mb-3">
                                    Our UI UX Designer Creates Digital Visitor Journeys that Activates   <span style={{ color: '#16539e' }}> Lead Conversions and Customer Relationships </span>
                                </h2>
                            </div>
                            <div className="col-lg-6 col-12 my-auto">
                                <div className="inner">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6 col-12 my-md-auto mb-md-auto mb-4">
                                {/* <h4 className='heading-sm'>About</h4> */}
                                <h2 className='heading heading my-3'>Logo Design<span className="dot">.</span></h2>
                            ...
                            <div className="col-lg-6 col-12 my-auto ">
                                <Image src={g1} alt="About" className='rounded-2 shadow-sm w-100' />
                            </div>
                        </div>
                    </div>
                </section>
                <section className="section py-md-5 py-2 bg-light">
                    <div className="container">
                        <div className="row flex-md-row flex-column-reverse">
                            <div className="col-lg-6 col-12 my-md-auto mb-md-auto mb-4">
                                <Image src={g2} alt="About" className='rounded-2 shadow-sm w-100' />
                            </div>
                            <div className="col-lg-6 col-12 my-md-auto mb-md-auto mb-4">
                                {/* <h4 className='heading-sm'>About</h4> */}
                                <h3 className='heading heading my-3'>Flyer / Brochure Design<span className="dot">.</span></h3>
                ...
                <section className="section py-md-5 py-2 ">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-12 my-md-auto mb-md-auto mb-4">
                                <Image src={g3} alt="About" className='rounded-2 shadow-sm w-100' />
                            </div>
                        </div>
                    </div>
                </section>
                <section className="section py-md-5 py-2 bg-light">
                    <div className="container">
                        <div className="row flex-md-row flex-column-reverse">
                            <div className="col-lg-6 col-12 my-md-auto mb-md-auto mb-4">
                                <Image src={g4} alt="About" className='rounded-2 shadow-sm w-100' />
                            </div>
                            <div className="col-lg-6 col-12 my-auto">
                                {/* <h4 className='heading-sm'>About</h4> */}
                                <h3 className='heading heading my-3'>Animation And Illustrations<span className="dot">.</span></h3>
                ...
                <section className="section py-md-5 py-2 ">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6 col-12 my-md-auto mb-md-auto mb-4">
                                {/* <h4 className='heading-sm'>About</h4> */}
                                <h2 className='heading heading my-3'>Product Packaging<span className="dot">.</span></h2>
                            ...
                            <div className="col-lg-6 col-12 my-auto ">
                                <Image src={g5} alt="About" className='rounded-2 shadow-sm w-100' />
                            </div>
                        </div>
                    </div>
                </section>
